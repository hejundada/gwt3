	...
	function L(a, b, c) {
		if(b.enablePagination) {
			var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
				...
				f = "";
			b.forceMoveForward || (f += e.format("previous", b.labels.previous)), b.enableCancelButton && (f += e.format("cancel", b.labels.cancel)), f += e.format("next", b.labels.next), b.enableFinishButton && (f += e.format("finish", b.labels.finish)), a.append(d.format(b.actionContainerTag, b.clearFixCssClass, b.labels.pagination, f)), D(a, b, c), A(a, b, c)
		}
	}
